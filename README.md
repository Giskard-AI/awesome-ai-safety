...
* [AI Displacement Tracker](https://github.com/noahaust2/ai-displacement-tracker) — Structured dataset tracking 96+ AI-attributed workforce displacement events (457K+ workers affected) across 13 countries and 13 sectors, with 3-tier source attribution methodology. CSV/JSON format, CC-BY-4.0.
