...
* [AdverseMed-500: A Physician-Verified False-Premise Benchmark for Measuring Miscalibration in Medical Language Models](https://github.com/calnugget/adversemed-500) (Vallamsetty, 2026) `#Calibration` `#Abstention` `#Medical` `#Benchmark`
